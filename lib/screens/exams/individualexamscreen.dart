...
class IndividualExamPage extends StatefulWidget {
  ...
  IndividualExamPage({Key key, this.exam, this.classcode}) : super(key: key);

  @override
  _IndividualExamPageState createState() => _IndividualExamPageState();
}
            ...
            child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      _formatDate(widget.exam.date.toDate()),
                      style:
                          TextStyle(fontWeight: FontWeight.w500, fontSize: 18),
                    ),
                  ],
                    ...
                    (widget.exam.moreDetailsLink != "")
                        ? ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () =>
                                  _launchURL(widget.exam.moreDetailsLink),
                            ))
                        : Container(
